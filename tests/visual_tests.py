...
notice("This is a notice", title="Nice Title", file=file)

warning_start_line = 10
warning("This is just a warning")
warning("This is a warning", title="Nice Title", file=file)

error_start_line = 10
error("This is just a error")
error("This is a error", title="Nice Title", file=file)
